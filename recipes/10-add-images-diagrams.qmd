...
## Mermaid Diagrams [version-badge new 0.2]
...
::: {.callout-note}
Keep images shared with the package README at the package root, using paths relative to that README.
Place documentation-only images under `docs/assets/` or beside their guide pages.
:::
