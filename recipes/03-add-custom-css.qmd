...
Great Docs ships a default stylesheet (`great-docs.css`) that works well out of the box. You can extend or override it with your own styles.
...
site:
  css:
    - great-docs.css       # Keep the defaults
