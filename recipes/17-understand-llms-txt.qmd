...
You do not need to configure anything to get these files. Great Docs generates them during the build in `docs/_quarto/default/` and deploys them in `docs/_site/` alongside the rest of your site.
