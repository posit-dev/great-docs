...
If the site does not load, check the following: make sure the CNAME file was included in the build output (look for it in `docs/_site/CNAME`), verify the DNS record is correct using a tool like `dig docs.example.com`, and confirm the GitHub Pages section in your repository settings shows the custom domain as active.
