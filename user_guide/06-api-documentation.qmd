...
| Generated output | `reference/` directory with `.qmd` files and `_sidebar.yml` | `docs/_quarto/default/` project (generated, gitignored) |
...
4. **Clean up quartodoc artifacts.** Great Docs generates its own `_quarto.yml` inside the
   generated `docs/_quarto/default/` directory on every build, so you don't need to edit or keep your
