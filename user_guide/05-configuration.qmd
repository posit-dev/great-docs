...
Different projects use different docstring conventions, so Great Docs automatically detects your docstring style during initialization. For a full guide on structuring docstrings (sections, executable examples, directives), see [Writing Docstrings](writing-docstrings.qmd).
...
See [API Documentation: Smart Method Handling](06-api-documentation.qmd#smart-method-handling) for detailed examples.
