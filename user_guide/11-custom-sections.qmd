...
Great Docs lets you add any number of custom page groups to your documentation site — examples, tutorials, demos, or anything else. Each section gets its own navbar link, sidebar navigation, and an auto-generated index page. For blog-style content, there's a dedicated `type: blog` mode that uses Quarto's native listing directive.
...
- **[Blog](blog.qmd)** – Set up a blog with Quarto's listing directive
