...
To customize the listing layout, provide your own `blog/index.qmd`. For example, to use a table layout (like [Great Tables' blog](https://posit-dev.github.io/great-tables/blog/)):
...
- **[Custom Sections](custom-sections.qmd)** – Add non-blog sections (examples, tutorials, etc.)
