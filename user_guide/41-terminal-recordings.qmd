...
| {{< keys "]" >}} | Jump to next chapter |
| {{< keys "[" >}} | Jump to previous chapter |
...
- **Previous Chapter** (⏴): Jump to the previous chapter marker (shortcut: {{< keys "[" >}})
- **Play/Pause** (▶/⏸): Toggle playback (shortcut: {{< keys "Space" >}})
- **Next Chapter** (⏵): Jump to the next chapter marker (shortcut: {{< keys "]" >}})
...
| {{< keys "[" >}} / {{< keys "]" >}} | Jump to previous / next chapter |
| {{< keys "Y" >}} | View YAML |
| {{< keys "P" >}} | Preview |
